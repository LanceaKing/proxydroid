...
public class Profile implements Serializable {
	...
	public ContentValues toContentValues() {
		...
		cv.put(Columns.IS_AUTH, isAuth);
		cv.put(Columns.IS_NTLM, isNTLM);
		cv.put(Columns.IS_AUTO_CONNECT, isAutoConnect);
		cv.put(Columns.IS_AUTO_SET_PROXY, isAutoSetProxy);
		cv.put(Columns.IS_BYPASS_APPS, isBypassApps);
		cv.put(Columns.IS_PAC, isPAC);
		cv.put(Columns.IS_DNS_PROXY, isDNSProxy);
